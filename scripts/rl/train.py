...
def main():
    ...
    if start_ep > 0:
        ...
        if os.path.exists(model_path):
            ...
            print(f"Warning: Resuming from episode {start_ep} but no model found at {model_path}")
    ...
    while current_ep < args.episodes:
        try:
            ...
            while True:
                choice = input("Options: [c]ontinue, [s]top and save, [p]lot and exit? ").lower().strip()
                if choice == 'c':
                    print("Resuming...")
